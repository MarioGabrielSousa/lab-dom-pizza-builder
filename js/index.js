...
function renderWhiteSauce() {
  if (state.whiteSauce) /*quer dizer que é true*/ {
...
function renderGlutenFreeCrust() {
  if (state.glutenFreeCrust) /*quer dizer que é true*/ {
...
function renderPrice() {
  ...
  if (state.pepperoni) {
    list.innerHTML += "<li>$1 pepperoni</li>"; //+= para somar ao que já lá está
